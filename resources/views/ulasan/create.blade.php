                    ...
                    <div class="card-body">
                        <form action="{{ route('ulasan.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control @error('ulasan') is-invalid @enderror" 
                                    name="ulasan" rows="5" placeholder="Masukkan ulasan">{{ old('ulasan')}}</textarea>
                            
                                <!-- error message untuk ulasan -->
                                @error('ulasan')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
