...
<body>
    <div class="container pt-3">
        <div class="d-flex mt-3 p-3  bg-ligth border border-dark-subtle w-auto h-auto justify-content-between"
            ...
            <div class="d-flex ">
                ...
                <div class="deskripsi-toko">
                    ...
                    <p class="text-success ms-2" style="margin-bottom: -25px"><i
                            class="bi bi-record-fill"></i><b>online</b><span class="text-dark ms-2 opacity-75"
                            style="margin-top: -25px;"><b>.</b> Bandung</span></p>
            ...
            <div class="d-flex h-25 mt-3">
                <div class="d-flex flex-row mb-3 mt-2">
                    <div class="p-2 justify-content-center">
                        <p class="mt-2 ps-4"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                fill="currentColor" class="bi bi-star-fill mb-2 text-warning" viewBox="0 0 16 16">
                                <path
                                    d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                            </svg><b> 4.8</b></p>
                        <p class="text-dark-emphasis pe-2" style="font-size: 0.9em; margin-top: -10px;">Rating & Ulasan
                        </p>
                    </div>
                    <div class="border-end border-dark-subtle"></div>
                    <div class="p-2 mt-2">
                        <p class="ps-4"><b>± 3 jam</b></p>
